...
import Migration0037 from "./Migrations/037_ProjectionProjectsRepoRoots.ts";
import Migration0038 from "./Migrations/038_ProjectionProjectsWorkspaceFile.ts";
import Migration0039 from "./Migrations/039_ProjectionCheckpointRefs.ts";
import Migration0040 from "./Migrations/040_ProjectionThreadsWorktrees.ts";
import Migration0041 from "./Migrations/041_HealSkippedProjectionThreadColumns.ts";
 ...
 * anyway; 041_HealSkippedProjectionThreadColumns repairs the one occurrence.
 */
export const migrationEntries = [
  ...
  [37, "ProjectionProjectsRepoRoots", Migration0037],
  [38, "ProjectionProjectsWorkspaceFile", Migration0038],
  [39, "ProjectionCheckpointRefs", Migration0039],
  [40, "ProjectionThreadsWorktrees", Migration0040],
  [41, "HealSkippedProjectionThreadColumns", Migration0041],
] as const;
