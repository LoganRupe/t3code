...
export class FilesystemScanGitReposError extends Schema.TaggedError<FilesystemScanGitReposError>()(
...
export class FilesystemReadWorkspaceFileError extends Schema.TaggedError<FilesystemReadWorkspaceFileError>()(
...
export class FilesystemWriteWorkspaceFileError extends Schema.TaggedError<FilesystemWriteWorkspaceFileError>()(
